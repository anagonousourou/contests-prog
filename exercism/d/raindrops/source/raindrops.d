string convert(int n)
{
    ...
    raindrops ~= n % 3 == 0 ? "Pling" : "";
    raindrops ~= n % 5 == 0 ? "Plang" : "";
    raindrops ~= n % 7 == 0 ? "Plong" : "";

    string raindropstring = raindrops.join();
    return raindropstring.length != 0 ? raindropstring : n.to!string;
}
