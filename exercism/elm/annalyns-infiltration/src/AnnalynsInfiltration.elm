...
canFreePrisoner knightIsAwake archerIsAwake prisonerIsAwake petDogIsPresent = (petDogIsPresent && not(archerIsAwake)) || (not(petDogIsPresent) && prisonerIsAwake && not(knightIsAwake) && not(archerIsAwake))
